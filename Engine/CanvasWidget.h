...
namespace UI
{
	class ENGINE_API CanvasWidget : public PanelWidget
	{
	public:
		FORCEINLINE virtual bool AddChild(AWidget* _widget) override
		{
		...
		FORCEINLINE CanvasSlot* GetSlotByWidget(AWidget* _widget)
		{
...
///////////////////////////////////////
//
// Step 1	: Create AWidget you want to add to the Canvas (Image, Label, ect...)
...
// Step 3	: Add the AWidget to the Canvas with AddChild
// Step 4	: Move the AWidget into your Canvas with SetPosition (Relative)
